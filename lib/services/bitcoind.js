...
Bitcoin.prototype.getAPIMethods = function () {
    var methods = [
        ...
        ['getsparknames', this, this.getsparknames, 0],
        ['getsparknametxdetails', this, this.getsparknametxdetails, 1],
...
Bitcoin.prototype.getsparknames = function(callback) {
    var self = this;
    this.client.getsparknames(function(err, response) {
    if (err) {
      return callback(self._wrapRPCError(err));
    }
    var result = response;
...
Bitcoin.prototype.getsparknametxdetails = function(param, callback) {
    var self = this;
    this.client.getsparknametxdetails(param, function(err, response) {
      if (err) {
        return callback(self._wrapRPCError(err));
      }
      var result = {
      ...
      if (response.result.additionalInfo !== undefined) {
        result.additionalInfo = response.result.additionalInfo;
      }
...
Bitcoin.prototype.evoznode = function(param, callback) {
    var self = this;
    this.client.evoznode(param, function(err, response) {
      if (err) {
        return callback(self._wrapRPCError(err));
      }
      var result = {
