...
var BASE_PACKAGE = {
    ...
    repository: 'git@github.com:firoorg/bitcore-node-zcoin.git#spark',
    license: 'MIT',
    readme: 'README.md',
    dependencies: {
        'zcore-lib': 'git://github.com/levonpetrosyan93/zcore-lib.git',
        'bitcore-node-zcoin': 'git@github.com:firoorg/bitcore-node-zcoin.git#spark',
